...
O projeto oferece uma experiência de aprendizado dinâmica e acessível por meio de conteúdos interativos, jogos educativos, simuladores e quizzes, promovendo a educação ambiental de forma prática e divertida.
...
* Impactos ambientais das ações humanas;
* Tecnologias limpas aplicadas ao meio rural.
...
* Professores;
* Comunidade interessada em sustentabilidade e meio ambiente.
...
| CSS3         | Estilização, gradientes e responsividade     |
| JavaScript   | Interatividade dos jogos, calculadora e quiz |
...
O sistema utiliza **LocalStorage** para salvar automaticamente a preferência de tema do usuário, proporcionando uma experiência personalizada.

### Responsividade

A interface foi desenvolvida para funcionar em diferentes dispositivos, incluindo:
...
* A adoção de práticas sustentáveis no campo e na cidade.
